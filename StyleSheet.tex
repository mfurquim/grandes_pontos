...
\KeywordTok{const} \NormalTok{NUMBER_DISC_COLORS = }\DecValTok{7}\NormalTok{;}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{for} \NormalTok{(}\KeywordTok{var} \NormalTok{discX = }\DecValTok{0}\NormalTok{; discX < NUMBER_DISC_ROW; discX++) \{}
  \KeywordTok{for} \NormalTok{(}\KeywordTok{var} \NormalTok{discY = }\DecValTok{0}\NormalTok{; discY < NUMBER_DISC_COL; discY++) \{}
    \CommentTok{// ---}
